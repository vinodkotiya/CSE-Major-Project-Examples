    ...
    If FState(Me.Tag).Dirty Then
        ...
        Select Case intResponse
            Case 6      ' User chose Yes.
                ...
                ' the user chose Cancel in the Save As dialog box; otherwise, save the file.
                If strFilename <> "" Then
...
End Sub
' Procedure for File >> Open option
...
Private Sub mnuRecentFile_Click(index As Integer)
    ...
    GetRecentFiles
End Sub
' Procedure to find text in notepad
