...
If BadGuys(x).Activated = 0 Then GoTo 10
    Set BadGuys(x).PicT = Form2.PicS
    Set BadGuys(x).mask = Form2.PicSm
    BadGuys(x).bulletlxpos = 16
    BadGuys(x).bulletlypos = 1
    BadGuys(x).bulletrxpos = 42
    BadGuys(x).bulletrypos = 1
    BadGuys(x).xsize = 62
    BadGuys(x).ysize = 44
    ...
    If BadGuys(x).Activated = 1 And BadGuys(x).Exploding = 0 Then
       If x > 1 And numsec < 40 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
       If x > 3 And numsec < 80 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
       If x > 5 And numsec < 120 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
       If x > 7 And numsec < 160 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
       If x > 9 And numsec < 200 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
       If x > 10 And numsec < 240 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
       If x > 12 And numsec < 280 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
...
If BadGuys(x).Bulletl(y).y > Form1.PicMain.ScaleHeight Then
   ...
   bullets = False
End If
BitBlt Form1.PicScreenBuffer.hdc, BadGuys(x).Bulletl(y).x, BadGuys(x).Bulletl(y).y, 6, 76, Form2.PicMissilem.hdc, 6 * frame, 0, vbMergePaint
BitBlt Form1.PicScreenBuffer.hdc, BadGuys(x).Bulletl(y).x, BadGuys(x).Bulletl(y).y, 6, 76, Form2.PicMissile.hdc, 6 * frame, 0, vbSrcAnd
frame = frame + 1
If frame > 9 Then frame = 0

If BadGuys(x).Bulletl(y).x + 8 > ShipX And BadGuys(x).Bulletl(y).x < ShipX + Form2.Picture1.ScaleWidth And _
...
If BadGuys(x).Bulletr(y).y > Form1.PicMain.ScaleHeight Then
   ...
   bullets = False
End If
BitBlt Form1.PicScreenBuffer.hdc, BadGuys(x).Bulletr(y).x, BadGuys(x).Bulletr(y).y, 6, 76, Form2.PicMissilem.hdc, 6 * frame, 0, vbMergePaint
BitBlt Form1.PicScreenBuffer.hdc, BadGuys(x).Bulletr(y).x, BadGuys(x).Bulletr(y).y, 6, 76, Form2.PicMissile.hdc, 6 * frame, 0, vbSrcAnd
frame = frame + 1
If frame > 9 Then frame = 0

If BadGuys(x).Bulletr(y).x + 8 > ShipX And BadGuys(x).Bulletr(y).x < ShipX + Form2.Picture1.ScaleWidth And _
