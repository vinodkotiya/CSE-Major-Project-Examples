...
If BadGuys(x).Activated = 0 Then GoTo 10
    ...
    If x > 1 And numsec < 20 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
    If x > 3 And numsec < 40 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
    If x > 5 And numsec < 60 Then BadGuys(x).y = Form1.PicMain.ScaleTop - 150
