VERSION 5.00
Begin VB.Form frmSearchBooksAlphabets 
   Caption         =   "Search Books :- Title"
   ClientHeight    =   3105
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7395
   Icon            =   "frmSearchBooksAlbhabets.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         Caption         =   "AccessionNos for the Title Selected"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Albhabets 
            Height          =   315
            ItemData        =   "frmSearchBooksAlbhabets.frx":0442
            Left            =   240
            List            =   "frmSearchBooksAlbhabets.frx":0444
   ...
   End
End
Attribute VB_Name = "frmSearchBooksAlphabets"
...
On Error Resume Next
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select distinct(Title) from BookI where Title like '" & Trim(UCase(Albhabets.text)) & "%' or Title like '" & Trim(LCase(Albhabets.text)) & "%' order by Title"
...
On Error Resume Next
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select AccessionNo from BookI where Title='" & Trim(GetString(List1.List(List1.ListIndex))) & "' order by AccessionNo"
            Set objrs = .Execute(query)
            List2.Clear
            If Not objrs.EOF Then
