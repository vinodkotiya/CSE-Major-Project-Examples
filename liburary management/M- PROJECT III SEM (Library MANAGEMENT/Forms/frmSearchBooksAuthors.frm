VERSION 5.00
Begin VB.Form frmSearchBooksAuthors 
   Caption         =   "Search Books :- Author"
   ClientHeight    =   3105
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7395
   Icon            =   "frmSearchBooksAuthors.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         Caption         =   "Titles by the Author Selected"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Albhabets 
            Height          =   315
            ItemData        =   "frmSearchBooksAuthors.frx":0442
            Left            =   240
            List            =   "frmSearchBooksAuthors.frx":0444
   ...
   End
End
Attribute VB_Name = "frmSearchBooksAuthors"
...
On Error Resume Next
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select distinct(Author) from BookI where Author like '" & Trim(UCase(Albhabets.text)) & "%' or Author like '" & Trim(LCase(Albhabets.text)) & "%' order by Author"
...
On Error Resume Next
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select Title from BookI where Author='" & Trim(GetString(List1.text)) & "' order by Title"
            Set objrs = .Execute(query)
            List2.Clear
            If Not objrs.EOF Then
