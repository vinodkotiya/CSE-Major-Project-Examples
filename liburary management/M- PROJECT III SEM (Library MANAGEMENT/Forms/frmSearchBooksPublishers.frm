VERSION 5.00
Begin VB.Form frmSearchBooksPublishers 
   Caption         =   "Search Books :- Publisher"
   ClientHeight    =   3105
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7395
   Icon            =   "frmSearchBooksPublishers.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         Caption         =   "Titles by the Publisher Selected"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Albhabets 
            Height          =   315
            ItemData        =   "frmSearchBooksPublishers.frx":0442
            Left            =   240
            List            =   "frmSearchBooksPublishers.frx":0444
   ...
   End
End
Attribute VB_Name = "frmSearchBooksPublishers"
...
On Error Resume Next
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select distinct(Publisher) from BookI where Publisher like '" & Trim(UCase(Albhabets.text)) & "%' or Publisher like '" & Trim(LCase(Albhabets.text)) & "%' order by Publisher"
...
On Error Resume Next
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select Title from BookI where Publisher='" & Trim(GetString(List1.text)) & "' order by Title"
            Set objrs = .Execute(query)
            List2.Clear
            If Not objrs.EOF Then
