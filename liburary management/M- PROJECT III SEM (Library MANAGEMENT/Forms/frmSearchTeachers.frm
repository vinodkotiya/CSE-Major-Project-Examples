VERSION 5.00
Begin VB.Form frmSearchTeachers 
   Caption         =   "Search Teachers :- Name"
   ClientHeight    =   3105
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7395
   Icon            =   "frmSearchTeachers.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Albhabets 
            Height          =   315
            ItemData        =   "frmSearchTeachers.frx":0442
            Left            =   240
            List            =   "frmSearchTeachers.frx":0444
   ...
   End
End
Attribute VB_Name = "frmSearchTeachers"
...
On Error Resume Next
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select Name from Teachers where Name like '" & Trim(Albhabets.text) & "%' order by Name"
...
Private Sub List1_Click()
    ...
    With ObjCon
        .Open FileDSN
            ...
            query = "select LCardNo from Teachers where Name='" & Trim(GetString(List1.List(List1.ListIndex))) & "' order by LCardNo"
            Set objrs = .Execute(query)
            List2.Clear
            If Not objrs.EOF Then
